...
//	@Test(description="文件夹路径")
//	public void testCopy_ref_folderPath(){
//		String path = vDirector;
//		String share_url = fileops.jsonDecode(fileops.shares(vDirector, null, uid), "url");
//		String pre_ref = share_url.substring(share_url.lastIndexOf("/")+1,share_url.length());
//		String cur_ref = generateCopy_ref(vDirector);
//		Assert.assertTrue(pre_ref.equals(cur_ref),"testCopy_ref_获取文件夹ref失败\n"
